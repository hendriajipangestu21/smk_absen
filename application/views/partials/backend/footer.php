<footer class="main-footer">
	...
	<strong>Copyright &copy; 2022 <a href="#">SMK Bhakti Husodo</a>.</strong> All rights
	reserved.
</footer>
...
<!-- overlayScrollbars -->
<script src="<?= base_url('myassets/adminlte') ?>/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>
<!-- AdminLTE App -->
